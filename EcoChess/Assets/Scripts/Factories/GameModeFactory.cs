...
namespace ChessGameModes {
    public enum GameMode {
        ...
        ChargeOfTheLightBrigadeChess, ChecklessChess, CheshireCatChess, Chess, Chess960, ChigorinChess, CylinderChess, DoubleChess, EmbassyChess,
        ExtinctionChess, FianchettoChess, GothicChess, GrandChess, GrasshopperChess, HalfChess, Horde, JanusChess, JesonMor, KingOfTheHill,
        Knightmate, LadderChess, LeganChess, LosAlamosChess, LosingChess, MaharajahChess, Microchess, MongredienChess, MonsterChess, NightriderChess,
