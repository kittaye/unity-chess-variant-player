...
namespace ChessGameModes {
    ...
    public class UpsideDown : Chess {
        ...
        public override void PopulateBoard() {
            ...
            AddPieceToBoard(new Rook(Team.BLACK, new BoardCoord(0, WHITE_BACKROW)));
            AddPieceToBoard(new Rook(Team.WHITE, new BoardCoord(0, BLACK_BACKROW)));
            AddPieceToBoard(new Rook(Team.BLACK, new BoardCoord(7, WHITE_BACKROW)));
            AddPieceToBoard(new Rook(Team.WHITE, new BoardCoord(7, BLACK_BACKROW)));
